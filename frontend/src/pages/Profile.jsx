...
function Profile() {
  ...
  const handleSaveProfile = (e) => {
    ...
    // Persist updated username/phone/photo locally until backend profile edit endpoint exists
    const updated = { ...user, username: editName.trim(), phone: editPhone.trim(), photo: editPhoto };
    localStorage.setItem("decisionhub-session", JSON.stringify(updated));
