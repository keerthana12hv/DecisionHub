...
class DecisionOptionIntegrationTest {
    ...
    void setUp() throws Exception {
        ...
        // Clean Decisions only after all dependent data
        ...
        // -------------------------------------------------
        // 3. Create default Decision directly in DB
        // -------------------------------------------------
        ...
        // -------------------------------------------------
        // 4. Create Options directly in DB
        // -------------------------------------------------

        DecisionOption option1 =
                new DecisionOption();

        option1.setOptionName(
                "Spring Boot"
        );
    ...
    @Test
    void testAddOption_DuplicateTitle_ReturnsBadRequest()
            throws Exception {
    ...
    @Test
    void testAddOption_Forbidden_NonOwner()
            throws Exception {
    ...
    void testUpdateOption_Success()
        ...
        mockMvc.perform(
                        put(
                                "/api/decisions/{decisionId}/options/{optionId}",
                                decisionId,
                                option2Id
                        )
                                .header(
                ...
                .andExpect(
                        jsonPath("$.description")
                                .value("Updated native description")
                );
    ...
    @Test
    void testDeleteOption_MinOptionsRuleViolation_ReturnsBadRequest()
            throws Exception {
    ...
    @Test
    void testDeleteOption_Success_AfterAddingThirdOption()
            throws Exception {

        OptionCreateDto addRequest =
                new OptionCreateDto(
                        "Micronaut",
                        "Third option",
                        Collections.emptyList()
    ...
    @Test
    void testOptionModificationOnActiveBoard_ReturnsBadRequest()
            throws Exception {
    ...
    void testGetOption_Success()
        ...
        mockMvc.perform(
                ...
                .andExpect(
                        jsonPath("$.description")
                                .value("Enterprise stack")
                );
    }

    @Test
    void testGetOption_NotFound()
            throws Exception {
    ...
    @Test
    void testGetOption_Forbidden_NonAuthorizedView()
            throws Exception {

        Decision privateDecision =
                new Decision();

        privateDecision.setTitle(
                "Private Board"
        );

        privateDecision.setDescription(
                "Only creator can see"
        );

        privateDecision.setCreator(
                userRepository
                        .findById(creatorId)
                        .orElseThrow()
        );

        privateDecision.setVisibility(
                DecisionVisibility.PRIVATE
        );

        privateDecision.setStatus(
                DecisionStatus.DRAFT
        );

        privateDecision.setCreatedAt(
                java.time.LocalDateTime.now()
        );
