...
class DecisionIntegrationTest {
    ...
    @Test
    void testDeleteActiveDecision_Owner_Success() throws Exception {
        User owner = userRepository.findById(creatorId).orElseThrow();
        Decision decision = new Decision();
        decision.setTitle("Active Decision");
        decision.setCreator(owner);
        ...
        mockMvc.perform(
                delete("/api/decisions/{id}", decision.getId())
    ...
    @Test
    void testDeleteClosedDecision_Owner_Success() throws Exception {
        User owner = userRepository.findById(creatorId).orElseThrow();
        Decision decision = new Decision();
        decision.setTitle("Closed Decision");
        decision.setCreator(owner);
        decision.setVisibility(com.decisionhub.enums.decision.DecisionVisibility.PUBLIC);
    ...
    @Test
    void testDeleteActiveDecision_Forbidden_NonOwner() throws Exception {
        User owner = userRepository.findById(creatorId).orElseThrow();
        Decision decision = new Decision();
        decision.setTitle("Active Decision");
        decision.setCreator(owner);
    ...
    @Test
    void testDeleteClosedDecision_Forbidden_NonOwner() throws Exception {
        User owner = userRepository.findById(creatorId).orElseThrow();
        Decision decision = new Decision();
        decision.setTitle("Closed Decision");
        decision.setCreator(owner);
