...
class DecisionOptionControllerTest {
    ...
    void createOption_withValidPayload_returnsCreated() throws Exception {
        ...
        OptionResponseDto response = new OptionResponseDto(optionId, "Quarkus", "Kubernetes native Java", Collections.emptyList(), Collections.emptyList());
    ...
    void updateOption_withValidPayload_returnsOk() throws Exception {
        ...
        OptionResponseDto response = new OptionResponseDto(optionId, "Updated title", "Updated desc", Collections.emptyList(), Collections.emptyList());
