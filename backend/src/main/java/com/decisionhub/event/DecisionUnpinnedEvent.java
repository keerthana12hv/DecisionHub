...
public class DecisionUnpinnedEvent extends ApplicationEvent {
    private final Long decisionId;
    private final String decisionTitle;
    private final Long moderatorId;

    public DecisionUnpinnedEvent(Object source, Long decisionId, String decisionTitle, Long moderatorId) {
        super(source);
