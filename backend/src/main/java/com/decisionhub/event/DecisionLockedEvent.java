...
public class DecisionLockedEvent extends ApplicationEvent {
    private final Long decisionId;
    private final String decisionTitle;
    private final Long moderatorId;

    public DecisionLockedEvent(Object source, Long decisionId, String decisionTitle, Long moderatorId) {
        super(source);
